<template>
  <div class="w-full">
    <h1 class="font-semibold text-2xl">Push Notifications</h1>
    <div class="w-full mt-8">
      <div class="flex flex-row">
        <span class="font-semibold mr-auto">Push Notification</span>
        <label
          for="push-notification-toggle"
      ...
      <div class="flex flex-row pt-8">
        <span class="font-semibold mr-auto">Email Notification</span>
        <label
    ...
    <button class="btn btn-primary rounded-lg font-semibold mt-8">Save</button>
  </div>
</template>
