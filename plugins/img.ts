import createOperationsGenerator from "~/utils/img/createOperationsGenerator";
  ...
  return {
    provide: {
      img: (src: string, modifiers = {}): string => {
        ...
        const baseURL = "https://ik.imagekit.io/SwapU"

        return withBase(withQuery(src, (operations ? { tr: operations } : {})), baseURL)
      },
    },
  };
});
